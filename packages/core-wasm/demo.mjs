...
// Dynamic import to handle different wasm-pack output formats
async function loadWasmModule() {
  try {
    const module = await import("./pkg/core_wasm.js");
    return {
      parse_and_validate_frontmatter: module.parse_and_validate_frontmatter,
      md_headings_to_yaml: module.md_headings_to_yaml,
      validate_yaml: module.validate_yaml,
      md_to_yaml: module.md_to_yaml,
      yaml_to_md: module.yaml_to_md,
    };
  } catch (e) {
