...
- [x] YAMLEditorとErrorBadge連携のためのApp.tsx更新
  - useYaml hookの統合
  - エラー情報の表示設定
  - エラークリック時のエディタ連携
...
- [x] `pnpm test` でuseYamlとErrorBadgeのテストがパスすること
- [x] 開発サーバーで動作を確認し、YAMLエディタでエラーを即時検知できること
- [x] エラーバッジがクリックできてエディタとの連携が機能すること
- [x] 以下のファイルが作成され、正常に動作すること:
  - hooks/useYaml.ts
  - components/ErrorBadge.tsx
